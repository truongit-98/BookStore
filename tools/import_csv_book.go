...
func fakeDataUser()  {
	...
	address := []string{"Hà Nội", "Thanh Hoá", "Bcắ Ninh", "Vĩnh Phúc", "TP Hồ Chí Minh", "Hiả Phnòg", "Thái Bình", "Nghệ An"}
	for i:=1; i<=100;i++{
...
func fakeDataCsv()  {
	csvFile, err := os.Open("/home/truongnv/go/src/BookStore/tools/book.csv")
	if err != nil {
		fmt.Println(err)
	}
